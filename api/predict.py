...
MODEL_PATH = os.path.join(os.path.dirname(__file__), "../student-performance/model.pkl")
PIPELINE_PATH = os.path.join(os.path.dirname(__file__), "../student-performance/pipeline.pkl")
